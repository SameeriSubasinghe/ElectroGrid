...
//{ 
// OverduePayment overduePayObj = new OverduePayment(); 
// 
// //Reading data from the overdue payment list
//@GET
//@Path("/") 
//@Produces(MediaType.TEXT_HTML) 
//public String readItems() 
// { 
// return overduePayObj.readODPayments(); 
// } 
//
////@POST
////@Path("/") 
